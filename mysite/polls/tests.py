...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_old_question(self):
        ...
        # was_published_recently() return False for questions whose pub_date is older that 1 day
    ...
    def test_was_published_recently_with_recent_question(self):
        # was_published_recently() returns True for questions whose pub_date is within the las day
